...
local EmotionManager = require("lib.modules.emotion.EmotionManager")
local EffectManager = require("lib.modules.effect.EffectManager")
...
function MnkyCApp:init()
	...
	self.EmotionManager = EmotionManager:getInstance()
